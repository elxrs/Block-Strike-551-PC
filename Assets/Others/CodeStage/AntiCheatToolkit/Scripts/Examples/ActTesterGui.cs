...
namespace CodeStage.AntiCheat.Examples
{
	...
	public class ActTesterGui : MonoBehaviour
	{
		...
		private void ObscuredFloatExample()
		{
			...
			obscuredFloat = obscuredFloat + 6f;
			obscuredFloat = obscuredFloat - 1.5f;
			++obscuredFloat;
			--obscuredFloat;
			--obscuredFloat;
				...
				using (new HorizontalLayout())
				{
					...
					using (new VerticalLayout(GUI.skin.box))
					{
						...
						using (new HorizontalLayout())
						{
							...
							if (GUILayout.Button("Add random value"))
							{
								obscuredString = obscuredString + (char)UnityEngine.Random.Range(97, 122);
							}
							if (GUILayout.Button("Reset"))
							{
						...
						using (new HorizontalLayout())
						{
							...
							if (GUILayout.Button("Add random value"))
							{
								obscuredInt = obscuredInt + UnityEngine.Random.Range(1, 100);
							}
							if (GUILayout.Button("Reset"))
							{
								obscuredInt = 0;
						...
						using (new HorizontalLayout())
						{
							...
							if (GUILayout.Button("Add random value"))
							{
								obscuredFloat = obscuredFloat + UnityEngine.Random.Range(1f, 100f);
							}
							if (GUILayout.Button("Reset"))
							{
								obscuredFloat = 0f;
