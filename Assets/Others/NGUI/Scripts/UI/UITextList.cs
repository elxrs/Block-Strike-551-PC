...
public class UITextList : MonoBehaviour
{
	...
	protected float lineHeight
	{
		get
		{
			return (!(textLabel != null)) ? 20f : (textLabel.fontSize + textLabel.effectiveSpacingY);
		}
	}
	...
	protected int scrollHeight
	{
		get
		{
			...
			int num = Mathf.FloorToInt(textLabel.height / lineHeight);
	...
	protected void Rebuild()
	{
		...
		if (scrollBar != null)
		{
			...
			if (uIScrollBar != null)
			{
				uIScrollBar.barSize = ((mTotalLines != 0) ? (1f - scrollHeight / mTotalLines) : 1f);
			}
		}
		UpdateVisibleText();
	}
	...
	protected void UpdateVisibleText()
	{
		...
		int num3 = Mathf.RoundToInt(mScroll * num2);
		if (num3 < 0)
		{
			num3 = 0;
		}
