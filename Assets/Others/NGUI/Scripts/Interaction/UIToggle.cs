...
[ExecuteInEditMode]
public class UIToggle : NGUIBehaviour
{
	...
	public void Set(bool state)
	{
		...
		else
		{
			...
			{
				ActiveAnimation activeAnimation2 = ActiveAnimation.Play(activeAnimation, null, state ? Direction.Forward : Direction.Reverse, EnableCondition.IgnoreDisabledState, DisableCondition.DoNotDisable);
