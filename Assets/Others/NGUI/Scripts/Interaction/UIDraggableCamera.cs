...
public class UIDraggableCamera : MonoBehaviour
{
	...
	private Vector3 CalculateConstrainOffset()
	{
		...
		Vector3 position = new Vector3(mCam.rect.xMin * Screen.width, mCam.rect.yMin * Screen.height, 0f);
		Vector3 position2 = new Vector3(mCam.rect.xMax * Screen.width, mCam.rect.yMax * Screen.height, 0f);
