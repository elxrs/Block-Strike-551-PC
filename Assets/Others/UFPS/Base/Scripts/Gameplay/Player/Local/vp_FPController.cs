...
public class vp_FPController : vp_Component
{
	...
	public CryptoFloatFast PhysicsGravityModifier = 0.2f;
	...
	protected virtual void SmoothMove()
	{
		...
		if (Vector3.Distance(Transform.position, m_SmoothPosition) > mCharacterController.radius)
		{
			m_SmoothPosition = Transform.position;
		}
	...
	protected virtual void UpdateSlopeFactor()
	{
		...
		m_SlopeFactor = nValue.float1 + (nValue.float1 - Vector3.Angle(m_GroundHit.normal, m_MotorThrottle) / nValue.int90);
