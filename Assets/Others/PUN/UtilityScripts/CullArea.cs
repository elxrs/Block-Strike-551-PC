...
public class CullArea : MonoBehaviour
{
	...
	private void CreateChildCells(CellTreeNode parent, int cellLevelInHierarchy)
	{
		...
		float num4 = parent.Size.x / num;
		for (int i = 0; i < num; i++)
		{
			for (int j = 0; j < num2; j++)
			{
				float num5 = num3 + i * num4 + num4 / 2f;
				...
				if (YIsUpAxis)
				{
					...
					float num7 = parent.Size.y / num2;
					float num8 = num6 + j * num7 + num7 / 2f;
				...
				else
				{
					...
					float num10 = parent.Size.z / num2;
					float num11 = num9 + j * num10 + num10 / 2f;
