...
public class NetworkCullingHandler : MonoBehaviour, IPunObservable
{
	...
	private void OnGUI()
	{
		...
		GUI.Label(new Rect(20f, Screen.height - 120f, 200f, 40f), "<color=white>PhotonView Group: " + pView.group + "</color>", new GUIStyle
		{
			alignment = TextAnchor.UpperLeft,
			fontSize = 16
		});
		GUI.Label(new Rect(20f, Screen.height - 100f, 200f, 40f), "<color=white>" + text + "</color>", new GUIStyle
		{
			alignment = TextAnchor.UpperLeft,
			fontSize = 16
		});
		GUI.Label(new Rect(20f, Screen.height - 60f, 200f, 40f), "<color=white>" + text2 + "</color>", new GUIStyle
		{
			alignment = TextAnchor.UpperLeft,
			fontSize = 16
		});
