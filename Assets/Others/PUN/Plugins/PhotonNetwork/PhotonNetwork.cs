...
public static class PhotonNetwork
{
	...
	private static CryptoInt sendInterval;

	private static CryptoInt sendIntervalOnSerialize;
	...
	public static int sendRate
	{
		get
		{
			return nValue.int1000 / (int)sendInterval;
		}
		set
		{
			sendInterval = nValue.int1000 / value;
			if (photonMono != null)
			{
	...
	public static int sendRateOnSerialize
	{
		get
		{
			return nValue.int1000 / (int)sendIntervalOnSerialize;
		}
		set
		{
			if (value > sendRate)
			...
			sendIntervalOnSerialize = nValue.int1000 / value;
			if (photonMono != null)
			{
	...
	public static double time
	{
		get
		{
			...
			return num / (double)nValue.int1000;
		}
	}
	...
	static PhotonNetwork()
	{
		...
		sendInterval = nValue.int50;
		sendIntervalOnSerialize = nValue.int100;
