...
public class BombAudio : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			if (BombTime > nValue.int20 && BombTime < nValue.int35 && BombCount != nValue.int1)
			{
			...
			else if (BombTime > nValue.int10 && BombTime < nValue.int20 && BombCount != nValue.int2)
			{
			...
			else if (BombTime > nValue.int0 && BombTime < nValue.int10 && BombCount != nValue.int3)
			{
