...
public class FPWeaponTwoHanded : MonoBehaviour
{
	...
	{
		m_PositionSpring.AddSoftForce(KnifeDelayForcePosition, KnifeDelayForce);
		m_RotationSpring.AddSoftForce(KnifeDelayForceRotation, KnifeDelayForce);
	}

	public void AddSoftForceKnifeAttack()
	{
		m_PositionSpring.AddSoftForce(KnifeAttackForcePosition, KnifeAttackForce);
		m_RotationSpring.AddSoftForce(KnifeAttackForceRotation, KnifeAttackForce);
	}
